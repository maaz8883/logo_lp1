...
coBtn.addEventListener('click', () => {
  ...
  const addonNames   = chosenAddons.map(a => a.name).join(', ');

  /* Build query string and redirect to payment page */
  ...
  /* ── Change this URL to your addon payment/checkout page ── */
  window.location.href = 'addon-checkout.php?' + params.toString();
});
